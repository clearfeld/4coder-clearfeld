...
clearfeld_set_bindings(Mapping *mapping, i64 global_id, i64 file_id, i64 code_id)
{
    ...
    ParentMap(global_id);
    {
        ...
        //Bind(multiple_cursors_backspace_char,         KeyCode_Backspace);
        
        Bind(move_up,                KeyCode_Up);
        Bind(move_down,              KeyCode_Down);
        // Bind(multiple_cursors_move_up,                KeyCode_Up);
        // Bind(multiple_cursors_move_down,              KeyCode_Down);
        
        // Bind(multiple_cursors_move_left,                KeyCode_Left);
        // Bind(multiple_cursors_move_right,              KeyCode_Right);
        ...
        //Bind(multiple_cursors_quit, KeyCode_Escape);
        
        BindTextInput(write_text_input);
        //BindTextInput(multiple_cursors_write_text_input);
        BindMouse(clearfeld_click_set_cursor_and_mark, MouseCode_Left);
        BindMouseRelease(clearfeld_click_set_cursor, MouseCode_Left);
        
        //BindMouse(multiple_cursors_set_cursor, MouseCode_Right);
        //BindMouseRelease(multiple_cursors_set_cursor, MouseCode_Right);
    ...
    ParentMap(file_id);
    {
        ...
        //BindTextInput(multiple_cursors_write_text_and_auto_indent);
