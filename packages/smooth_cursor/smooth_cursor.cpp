...
// https://github.com/ryanfleury/4coder_fleury/blob/master/4coder_fleury_cursor.cpp
...
CUSTOM_COMMAND_SIG(toggle_smooth_cursor)
CUSTOM_DOC("Toggles smooth cursor effect.")
{
    smooth_cursor_mode = !smooth_cursor_mode;
}
