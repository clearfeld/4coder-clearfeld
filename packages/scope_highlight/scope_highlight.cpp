//
// Modifed version of https://4coder.handmade.network/wiki/7384-%5Bmodule%5D_scope_highlight
// by mr mixer
//

// BUGS TODO: FIXME:
// { "a", "b" },
// multi declare on same line triggers line hihglight underline
//

/*
# Description

This module provides scope highlighting by drawing colored lines aligned to the
...
'''c
function void scope_highlight_draw( Application_Links *app, Buffer_ID buffer, Text_Layout_ID text_layout_id, i64 pos, View_ID view);
'''
...
highlight in 'default_render_buffer'.
...
static bool internal_package__render_scope_highlight_line = true;

CUSTOM_ID(colors, scope_highlight_line_cycle);

function void
clearfeld__scope_line_highlight_draw(Application_Links *app, Buffer_ID buffer, Text_Layout_ID text_layout_id, i64 pos, View_ID view)
{
...
CUSTOM_COMMAND_SIG(clearfeld__toggle_scope_line_highlight)
CUSTOM_DOC("Toggles the scope line highlight draw.")
{
    internal_package__render_scope_highlight_line = !internal_package__render_scope_highlight_line;
}

CUSTOM_COMMAND_SIG(clearfeld__scope_line_highlight_and_enclosing_on)
CUSTOM_DOC("Turn on scope line highlight and enclosing scope block highlight.")
{
    internal_package__render_scope_highlight_line = true;
    global_config.use_scope_highlight = true;
}

CUSTOM_COMMAND_SIG(clearfeld__scope_line_highlight_and_enclosing_off)
CUSTOM_DOC("Turn off scope line highlight and enclosing scope block highlight.")
{
    internal_package__render_scope_highlight_line = false;
    global_config.use_scope_highlight = false;
}
